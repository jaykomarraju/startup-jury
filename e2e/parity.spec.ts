...
const EXPECTED: Record<string, Screen> = {
  ...
  // V3-PT item 17, audience widened by S3-ACCOUNT — v3's "Choose your seat" is
  // the INCUBATOR's screen (superuser AND admin, per the client's 21-Sep row for
  // My account); only the VC rows below still read "Choose your plan".
  ...
  "vc/superuser/funnel": { title: "Pipeline Funnel", tables: [["STAGE", "COUNT", "% OF SOURCED", "STEP CONVERSION"]] },
  "vc/superuser/capital": {
    title: "Capital Deployment & Pacing",
    tables: [["PERIOD", "PLANNED", "ACTUAL", "CUMULATIVE", "VARIANCE"]],
  },
  "vc/superuser/portfolio": { title: "Portfolio Construction", tables: [["SECTOR", "ACTUAL", "TARGET", "DRIFT"]] },
  "vc/superuser/scoring": {
    title: "Scoring Summary",
    tables: [["STARTUP", "AI", "EVALUATOR AVG", "VARIANCE", "SPREAD", "LEAN"]],
  },
  "vc/superuser/diligence": {
  ...
  "vc/superuser/decisions": { title: "Decision History", tables: [["DATE", "COMPANY", "DECISION", "IC LEAD", "NOTE"]] },
  ...
  "vc/admin/funnel": { title: "Pipeline Funnel", tables: [["STAGE", "COUNT", "% OF SOURCED", "STEP CONVERSION"]] },
  "vc/admin/capital": {
    title: "Capital Deployment & Pacing",
    tables: [["PERIOD", "PLANNED", "ACTUAL", "CUMULATIVE", "VARIANCE"]],
  },
  "vc/admin/portfolio": { title: "Portfolio Construction", tables: [["SECTOR", "ACTUAL", "TARGET", "DRIFT"]] },
  "vc/admin/scoring": {
    title: "Scoring Summary",
    tables: [["STARTUP", "AI", "EVALUATOR AVG", "VARIANCE", "SPREAD", "LEAN"]],
  },
  ...
  "vc/admin/decisions": { title: "Decision History", tables: [["DATE", "COMPANY", "DECISION", "IC LEAD", "NOTE"]] },
  "vc/admin/coreparams": {
    title: "Core Parameters — Area weights",
    tables: [["#", "EVALUATION AREA", "TYPE", "WEIGHT %", "VISUAL"]],
  },
  ...
  "vc/partner/funnel": { title: "Pipeline Funnel", tables: [["STAGE", "COUNT", "% OF SOURCED", "STEP CONVERSION"]] },
  "vc/partner/capital": {
    title: "Capital Deployment & Pacing",
    tables: [["PERIOD", "PLANNED", "ACTUAL", "CUMULATIVE", "VARIANCE"]],
  },
  "vc/partner/portfolio": { title: "Portfolio Construction", tables: [["SECTOR", "ACTUAL", "TARGET", "DRIFT"]] },
  "vc/partner/scoring": {
    title: "Scoring Summary",
    tables: [["STARTUP", "AI", "EVALUATOR AVG", "VARIANCE", "SPREAD", "LEAN"]],
  },
  ...
  "vc/partner/decisions": { title: "Decision History", tables: [["DATE", "COMPANY", "DECISION", "IC LEAD", "NOTE"]] },
  ...
  "vc/ic_member/capital": {
    title: "Capital Deployment & Pacing",
    tables: [["PERIOD", "PLANNED", "ACTUAL", "CUMULATIVE", "VARIANCE"]],
  },
  "vc/ic_member/portfolio": { title: "Portfolio Construction", tables: [["SECTOR", "ACTUAL", "TARGET", "DRIFT"]] },
  "vc/ic_member/scoring": {
    title: "Scoring Summary",
    tables: [["STARTUP", "AI", "EVALUATOR AVG", "VARIANCE", "SPREAD", "LEAN"]],
  },
  "vc/ic_member/diligence": {
    title: "Diligence & Risk Status",
    tables: [
      ["ITEM", "COMPANY", "OWNER", "STATUS"],
      ["COMPANY", "FLAG"],
  ...
  "vc/ic_member/decisions": { title: "Decision History", tables: [["DATE", "COMPANY", "DECISION", "IC LEAD", "NOTE"]] },
  ...
  "vc/associate/funnel": { title: "Pipeline Funnel", tables: [["STAGE", "COUNT", "% OF SOURCED", "STEP CONVERSION"]] },
  "vc/associate/capital": {
    title: "Capital Deployment & Pacing",
    tables: [["PERIOD", "PLANNED", "ACTUAL", "CUMULATIVE", "VARIANCE"]],
  },
  "vc/associate/portfolio": { title: "Portfolio Construction", tables: [["SECTOR", "ACTUAL", "TARGET", "DRIFT"]] },
  "vc/associate/scoring": {
    title: "Scoring Summary",
    tables: [["STARTUP", "AI", "EVALUATOR AVG", "VARIANCE", "SPREAD", "LEAN"]],
  },
  "vc/associate/diligence": {
    title: "Diligence & Risk Status",
    tables: [
      ["ITEM", "COMPANY", "OWNER", "STATUS"],
      ["COMPANY", "FLAG"],
  ...
  "vc/associate/decisions": { title: "Decision History", tables: [["DATE", "COMPANY", "DECISION", "IC LEAD", "NOTE"]] },
