...
const EXPECTED: Record<string, Screen> = {
  ...
  "incubator/superuser/coreparams": {
    title: "Configuration",
    tables: [["#", "EVALUATION AREA", "WEIGHT %", "VISUAL"]],
  },
  "incubator/superuser/myparams": { title: "My Parameters", tables: [] },
  "incubator/superuser/setup": { title: "Set up your workspace", tables: [] },
  "incubator/superuser/account": { title: "My account", tables: [] },
  "incubator/superuser/admin": {
    title: "Admin console",
    tables: [["MEMBER", "ROLE", "ORGANIZATIONAL TITLE", "TYPE", "STATUS", "ACTION"]],
  },
  "incubator/superuser/billing": { title: "Buy credits", tables: [] },
  ...
  "incubator/admin/account": { title: "My account", tables: [] },
  "incubator/admin/admin": {
    title: "Admin console",
    tables: [["MEMBER", "ROLE", "ORGANIZATIONAL TITLE", "TYPE", "STATUS", "ACTION"]],
  },
  "incubator/admin/billing": { title: "Buy credits", tables: [] },
  ...
  "vc/superuser/coreparams": { title: "Configuration", tables: [["#", "EVALUATION AREA", "WEIGHT %", "VISUAL"]] },
  "vc/superuser/myparams": { title: "My Parameters", tables: [] },
  "vc/superuser/setup": { title: "Set up your workspace", tables: [] },
  "vc/superuser/account": { title: "My account", tables: [] },
  "vc/superuser/admin": {
    title: "Admin console",
    tables: [["MEMBER", "ROLE", "ORGANIZATIONAL TITLE", "TYPE", "STATUS", "ACTION"]],
  },
  "vc/superuser/billing": { title: "Buy credits", tables: [] },
  ...
  "vc/admin/coreparams": { title: "Configuration", tables: [["#", "EVALUATION AREA", "WEIGHT %", "VISUAL"]] },
  "vc/admin/myparams": { title: "My Parameters", tables: [] },
  "vc/admin/setup": { title: "Set up your workspace", tables: [] },
  "vc/admin/account": { title: "My account", tables: [] },
  "vc/admin/admin": {
    title: "Admin console",
    tables: [["MEMBER", "ROLE", "ORGANIZATIONAL TITLE", "TYPE", "STATUS", "ACTION"]],
  },
  "vc/admin/billing": { title: "Buy credits", tables: [] },
  ...
  "vc/partner/myparams": { title: "My Parameters", tables: [] },
  ...
  "vc/ic_member/myparams": { title: "My Parameters", tables: [] },
  ...
  "vc/associate/myparams": { title: "My Parameters", tables: [] },
  ...
  "vc/analyst/myparams": { title: "My Parameters", tables: [] },
