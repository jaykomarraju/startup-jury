...
CONSTRAINTS
  - Own only: src/server/routes/auth.ts, src/client/routes/AccountPage.tsx (or whatever My account
    is, check `nav.ts` for the `account` slug), and your own new files. You own migration 0048.
