...
| **Q-P** | V3-UP for the PM — their own prototype's bottom action bar, or V3's toolbar "AI Evaluate" button? | **V3's.** It is the later file and it keeps the PM's screen identical to the admin's and PA's, which is the whole point of this exercise. |
